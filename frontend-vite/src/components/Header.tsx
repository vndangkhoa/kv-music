...
import { Search, Settings, Cast, LogOut, Menu } from 'lucide-react';
            ...
            <header className="h-14 md:h-16 bg-[#0f0f0f] border-b border-white/5 flex items-center justify-between px-3 md:px-6 z-[60] relative select-none">
                ...
                <div className="flex items-center gap-2 md:gap-4">
                    <button
                        ...
                        className="p-2 hover:bg-white/10 rounded-lg transition hidden fold:flex"
                ...
                {/* Center Section: Pill Search Capsule */}
                <form onSubmit={handleFormSubmit} className="flex-1 max-w-[480px] mx-4 relative hidden sm:block">
                ...
                <div className="flex items-center gap-3 md:gap-4 text-neutral-300">
                    <button className="hover:text-white active:scale-95 transition p-1">
                        <Cast className="w-5 h-5" />
                    </button>
                    <button
                        onClick={() => setIsSettingsOpen(true)}
                        className="hover:text-white active:scale-95 transition p-1"
                    >
